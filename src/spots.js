...
export const SPOTS = [
  {
    ...
    palette: {
      sky: ['#9fd8ff', '#dff2ff'], sun: '#fff4d6', sunPos: [-80, 68, 120],
  ...
  },
  {
    ...
    palette: {
      sky: ['#ff9b54', '#ffd89b'], sun: '#fff0b8', sunPos: [-40, 26, 150],
  ...
  },
  {
    ...
    palette: {
      sky: ['#5ec8ff', '#eafaff'], sun: '#ffffff', sunPos: [-120, 95, 70],
  ...
  },
  {
    ...
    palette: {
      sky: ['#6fb7e8', '#e6f3ff'], sun: '#fff6df', sunPos: [-70, 78, 110],
  ...
  },
  {
    ...
    palette: {
      sky: ['#ff6b5e', '#ffc46b'], sun: '#ffe9a8', sunPos: [-55, 20, 140],
  ...
  },
  {
    ...
    palette: {
      sky: ['#48617f', '#b9cfe0'], sun: '#e8f0ff', sunPos: [-130, 42, 90],
