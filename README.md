...
- **Three.js arrive par importmap depuis jsDelivr**, version épinglée et vérifiée par `integrity` dans `index.html`. Aucune dépendance npm, aucun build, aucun asset : tout est généré (falaise, eau, plongeur, son).
